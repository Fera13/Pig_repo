...
class testGameFunctionality(unittest.TestCase):
    def test_view_Highscores_wrongType(self):
        '''Tests that an error will be raised if the wrong type of arguments is entered'''
        with self.assertRaises(ValueError):
            hs.view_HighScores("hi")

    def test_add_Compare_Highscores(self):
        '''Tests that the high score dictionary will be returned after adding or replacing keys and values to it'''
    ...
    def test_get_HighScore_Dic(self):
        '''Tests that the high score dictionary will be returned when asking to get it'''
    ...
    def test_update_High_Score(self):
        '''Tests that the updated high score dictionary will be returned after changing a key in it'''
